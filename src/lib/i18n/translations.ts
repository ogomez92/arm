export const translations = {
	...
	es: {
		...
		duplicateIssue: 'Duplicar Problema',
		export: 'Exportar',
		...
		confirmDelete: '¿Estás seguro de que quieres eliminar este problema?',
		error: 'Error',
		...
		spanish: 'Español',
		actions: 'Acciones',
		noReportLoaded: 'No hay ningún informe cargado. Por favor, sube o crea un informe.',
